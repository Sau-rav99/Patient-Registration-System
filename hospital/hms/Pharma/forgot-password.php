...
$email=$_POST['email'];
$query=mysqli_query($con,"select pharmacy_id from  pharmacy where contact_no='$contactno' and email='$email'");
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.html"><h2> PRS | Pharmacy Password Recovery</h2></a>
				</div>
