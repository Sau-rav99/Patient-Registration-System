...
if (isset($_POST['submit'])) {
    ...
    $totalcharge = $consultation_fee; // Calculate total charge
    ...
    $stmt = $con->prepare("INSERT INTO bill (patient_id,  consultation_fee, total_charge, date_issued, status, amount_to_be_paid) VALUES (?, ?, ?, CURRENT_TIMESTAMP, ?, ?)");
    $stmt->bind_param("iddsd", $patid,  $consultation_fee, $totalcharge, $status, $amnt_to_paid);
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Doctor | Add Bill</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                                    <span>Doctor</span>
                                            ...
                                            <div class="panel-body">
                                                <form role="form" id="reportform" name="reportform" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="consultation_fee" class="form-control" placeholder="Consultation Fee" required="true">
                                                    </div>
                                                    <!-- <div class="form-group">
