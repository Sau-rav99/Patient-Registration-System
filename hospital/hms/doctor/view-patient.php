    ...
    <div class="app-content">
                  ...
                  <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo $row['CreationDate']; ?></td>
                        <td>
                          <a href="download_prescription.php?prescId=<?php echo $row['ID']; ?>">Download Precription</a>
                        </td>
                      </tr>
                    <?php $cnt = $cnt + 1;
                    } ?>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <table class="table table-bordered table-hover data-tables">
                            ...
                            <form method="post" name="submit" id="prescriptionform">
                              ...
                              <tr>
                                <th>Prescription :</th>
                                <td>
                                  <textarea id="prescription" name="pres" placeholder="Medical Prescription" rows="12" cols="14" class="form-control wd-450" required="true"></textarea>
                                </td>
                              </tr>
      ...
      <script>
        ...
        document.getElementById('prescriptionform').onsubmit = function() {
          var textarea = document.getElementById('prescription');
