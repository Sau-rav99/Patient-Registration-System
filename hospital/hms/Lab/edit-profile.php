...
if (isset($_POST['submit'])) {
	...
	$email = $_POST['email'];
	$sql = mysqli_query($con, "Update laboratorist set name='$name',contactno='$contactno',qualification = '$qual' where id='" . $_SESSION['id'] . "'");
	if ($sql) {
...
<head>
	<title>Doctor | Edit Your Details</title>
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Lab | Edit Doctor Details</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Lab</span>
									...
									<div class="col-lg-8 col-md-12">
										<div class="panel panel-white">
											...
											<div class="panel-body">
												<?php $sql = mysqli_query($con, "select * from laboratorist where email='" . $_SESSION['llogin'] . "'");
												...
												?>
													...
													<form role="form" name="adddoc" method="post" onSubmit="return valid();">
														...
														<div class="form-group">
															...
															<input type="text" name="qual" class="form-control" required="required" value="<?php echo htmlentities($data['qualification']); ?>">
														</div>
