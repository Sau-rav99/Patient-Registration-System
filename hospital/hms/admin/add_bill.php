...
if (isset($_POST['submit'])) {
    ...
    $totalcharge = $roomcharge + $medicationcharge + $consultationfee; // Calculate total charge
    ...
    $stmt = $con->prepare("INSERT INTO bill (patient_id, room_charge, medication_charge, consultation_fee, total_charge, date_issued, status, amount_to_be_paid) VALUES (?, ?, ?, ?, ?, CURRENT_TIMESTAMP, ?, ?)");
    $stmt->bind_param("iddddsd", $patid, $roomcharge, $medicationcharge, $consultationfee, $totalcharge, $status, $amnt_to_paid);
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Admin | Add Bill</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                                    <span>Admin</span>
