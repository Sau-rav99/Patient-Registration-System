											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<table class="table table-bordered table-hover data-tables">
														...
														<form method="post" id="submit" name="submit" id="prescriptionform">
															...
															<tr>
																<th>Prescription :</th>
																<td>
																	<textarea id="pres" name="pres" placeholder="Medical Prescription" rows="12" cols="14" class="form-control wd-450" required="true"></textarea>
																</td>
															</tr>
