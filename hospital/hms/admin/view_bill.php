			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Admin | View Bills</h1>
							</div>
							<ol class="breadcrumb">
								<li>
									<span>Admin</span>
							...
							<div class="col-md-12">
								...
								<table class="table table-hover" id="sample-table-1">
									...
									<tbody>
										...
										$totalCharge = 0;
										$sql = mysqli_query($con, "select * from bill as b,tblpatient as p WHERE b.patient_id = p.ID");
										$cnt = 1;
										...
										?>
											<tr>
												...
												<td class="center"><?php echo $row['patient_id']; ?>.</td>
												...
												<td>
													...
													<a href="edit_bill.php?editid=<?php echo $row['bill_id']; ?>"><i class="fa fa-edit"></i></a>
